    ...
    <section class="connexion">
        ...
        <form  method="post" action="">
            ...
            <div class="remember-forgot">
                <label><input class="remember" type="checkbox">Se souvenir de moi</label>
            </div>
            
            <div class="button1_co">
            <input type="submit" value="Se connecter" name="connexion" class="ok">
            </div>
            <?php
include("bdd.php");
